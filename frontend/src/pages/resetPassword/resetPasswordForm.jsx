...
function ResetPasswordForm() {
    ...
    const{New_Password}=userDetails;
                ...
                <div>
                    ...
                    <Form className={styles.form} onSubmit={formSubmission} method="POST">
                        ...
                        <Form.Group className="mb-3" controlId="formBasicEmail">
                            <Form.Control type="password" placeholder="New Password"  name="New_Password" required className={styles.input} value={New_Password} onChange={InputHandler}/>
                        </Form.Group>
