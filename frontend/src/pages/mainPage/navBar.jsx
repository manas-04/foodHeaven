...
function NavBar(props) {
	...
	return (
		<nav className='navbar-expand-lg navbar-light localNavBar'>
			...
			<div className='itemDiv'>
				<a className='nav-item localNavItem' href='/comingSoon'>
					Features
				</a>
				<a className='nav-item localNavItem' href='#categories'>
					Categories
				</a>
				<a className='nav-item localNavItem' href='/aboutUs'>
					Contacts
				</a>
				{localStorage.getItem("token") && (
					<a className='nav-item localNavItem' href='/dashboard'>
						Dashboard
					</a>
				)}
			</div>
