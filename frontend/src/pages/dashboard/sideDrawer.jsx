				...
				props.visible ?
					<div className={styles.sideDrawer}>
						...
						<DrawerNavigation>
							...
							<ListItem imageUrl="./images/explore_black_24dp.svg" Item="Explore" onClick={() => { props.handleClickOpen(); props.changeVisibility() }} />
							<ListItem redirectLink="#categories" imageUrl="./images/categories.svg" Item="Categories" onClick={props.changeVisibility} />
							<ListItem redirectLink="/comingSoon" imageUrl="./images/history.svg" Item="History" onClick={props.changeVisibility} />
							<ListItem redirectLink="/comingSoon" imageUrl="./images/diary-1118.svg" Item="View Saved Recipies" onClick={props.changeVisibility} />
							<center>
								<hr
									className={styles.hr}
							...
							<ListItem redirectLink="/manageProfile" imageUrl="./images/profile.svg" Item="Manage Profile" onClick={props.changeVisibility} />
							...
							<ListItem redirectLink="/comingSoon" imageUrl="./images/question-answer-5528.svg" Item="About Us" onClick={props.changeVisibility} />
							<Nav.Item onClick={props.changeVisibility}>
